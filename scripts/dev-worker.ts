...
const configured = loadLocalBindings();
const mf = new Miniflare(convertV4MiniflareOptions({
  ...
  bindings: { ...configured,LOCAL_DEVELOPMENT: 'true',SESSION_SIGNING_SECRET: configured.SESSION_SIGNING_SECRET || randomBytes(48).toString('hex') },
...
process.stdout.write('Reframe local Worker ready at http://127.0.0.1:8787 (persistent D1 and FILES; AI requires server-side key and budget).\n');
