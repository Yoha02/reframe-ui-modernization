...
![Reframe's before-and-after slider showing the original Space Jam homepage on the left and a rebuilt static page on the right](docs/images/comparison-slider.png)
...
| --- | --- |
| [![Source evidence workspace with captured pages, original screenshots, preserved images and links](docs/images/source-evidence.png)](docs/images/source-evidence.png) | [![Evaluation screen with findings linked back to captured source evidence](docs/images/evaluation.png)](docs/images/evaluation.png) |
...
| --- | --- |
| [![Visual component board with original screenshot crops and connections between reusable groups](docs/images/component-board.png)](docs/images/component-board.png) | [![Design-system editor showing editable background, surface, text, primary and accent colors](docs/images/design-system.png)](docs/images/design-system.png) |
...
| --- | --- |
| [![Typography and corner-radius controls alongside a live component and spacing preview](docs/images/design-preview.png)](docs/images/design-preview.png) | [![Rebuilt page displayed in Reframe's 390-pixel mobile preview](docs/images/mobile-preview.png)](docs/images/mobile-preview.png) |
